...
* **[Collector](/docs/collector)**
  ...
  - [Upgrading](/docs/collector/upgrading)

<hr />

* **[Index Advisor](/docs/index-advisor)**
* **[Indexing Engine](/docs/indexing-engine)**
* **[Alerts & Check-Up](/docs/checks)**
* **[Connections](/docs/connections)**
* **[Account Management](/docs/accounts)**
  - [Permissions and Roles](/docs/accounts/permissions)
  - [Single Sign-On](/docs/accounts/sso)
    * [Okta integration](/docs/accounts/sso/okta)
    * [Custom SAML 2.0 integration](/docs/accounts/sso/saml2)
