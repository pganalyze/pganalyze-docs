...
* **[Log Insights Initial Setup](/docs/log-insights/setup)**
  ...
  - [Self-managed Postgres Server](/docs/log-insights/setup/self-managed/01_determine_log_location)
...
* **[Automated EXPLAIN Initial Setup](/docs/explain/setup)**
  ...
  - [Self-managed Postgres Server](/docs/explain/setup/self_managed/01_auto_explain_check)
