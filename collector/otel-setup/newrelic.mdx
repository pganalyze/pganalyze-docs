...
guided install and install the New Relic agent, or use OpenTelemetry SDKs.
You can read how to setup OpenTelemetry integration in [their documentation](https://docs.newrelic.com/docs/more-integrations/open-source-telemetry-integrations/opentelemetry/get-started/opentelemetry-set-up-your-app/).
...
For Go, it is the best to use the OpenTelemetry SDK as it will integrate well
with sqlcommenter and the traceparent query tag will be added without any extra
setups.
