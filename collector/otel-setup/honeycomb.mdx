...
2. Add traceparent query tag to the query (see [Set up traceparent query tag within your application](/docs/collector/otel-setup/traceparent) section for details)
...
the service name reported to Honeycomb from the pganalyze collector.
