...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Path to SSL certificate authority (CA) certificate(s) to use to verify the server's certificate, or <code>rds-ca-global</code> to use the built-in AWS RDS certificates</td>
    </tr>
    <tr>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        / cluster, and the pganalyze IAM policy needs to <a href="https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/UsingWithRDS.IAMDBAuth.IAMPolicy.html">cover the "rds-db:connect" privilege</a> for
        the pganalyze user.
      </td>
    </tr>
    <tr>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        and tables. For very large schemas, this collection can be a performance problem. When using this option it's
