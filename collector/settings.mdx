...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>[none]</td>
      <td>
        The "Application (client) ID" on your application.
        For Managed Identity, particularly with multiple VM identities, avoid using this parameter.
        Instead, set the <code>AZURE_CLIENT_ID</code> environment variable to specify the identity
      </td>
    </tr>
    <tr>
