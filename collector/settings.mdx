...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Auto detected</td>
      <td>Sets the identity of the cluster the server belongs to. Defaults to cluster ID retrieved from cloud provider APIs (if available), or to the Postgres database system identifier for self-managed servers.
      </td>
    </tr>
    <tr>
