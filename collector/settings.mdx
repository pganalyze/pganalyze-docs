...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>false</td>
      <td>Set to 'true' if the CloudSQL proxy connextion should use the available public IP rather than the default private IP. Setting
        to true when no public IP is assigned will result in a connection error.</td>
    </tr> 
  </tbody>
</table>
