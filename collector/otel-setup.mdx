...
* [Integrating pganalyze with Honeycomb](/docs/collector/otel-setup/honeycomb)
* [Integrating pganalyze with New Relic](/docs/collector/otel-setup/newrelic)
...
* Queries must contain the `traceparent` query tag, by
  [configuring the application to add it as a SQL comment](/docs/collector/otel-setup/traceparent).
