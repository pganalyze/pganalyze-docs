...
find a new action "Tune query in workbook". This creates your first workbook
...
[Continue with Query Optimization Examples](/docs/query-tuning/query-optimization-examples)
