...
the index, weighted by the frequency (calls / minute) of the scan.
...
the full details in the per-table Index Advisor view.

todobison https://pganalyze.com/docs/index-advisor/getting-started
