...
will generate EXPLAIN plans. You can read the full Postgres documentation about these <AutoExplainLink version={props.pgMajorVersion}>here</AutoExplainLink>.
