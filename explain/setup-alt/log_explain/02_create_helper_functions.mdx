...
The safest way to permit this is to use the following helper function:
...
<Link className='btn btn-success' to='03_testing_the_configuration'>
  Proceed to Step 3: Testing the configuration
</Link>
