...
To make collection and interpretation of plans easier, you can utilize **[auto_explain](/docs/setup/auto_explain)** and **[pganalyze EXPLAIN Insights](/docs/explain/insights)** to get automated insights into what can be optimized about a query plan.