...
* In the "VACUUM Blocked by Xmin Horizon" graph, when the exact assigned time of the xmin horizon wasn't retrievable (e.g. it was assigned before the statistics retention period), it will use the oldest statistics collected time and can be inaccurate. For example, even if the xmin horizon was assigned at 60 days ago, the xmin horizon in the graph may show that it was assigned at 35 days ago
