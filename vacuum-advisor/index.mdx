...
The insights are enabled by default for all your database servers, but you need to set up an alert rule and destination (for example, a Slack channel) to be notified of newly detected insights. Read more details about the [Alerts & Check-Up system](/docs/checks).
