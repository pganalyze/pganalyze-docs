...
[release page](/docs/enterprise/releases) which version of the Indexing Engine is included.

## 2022-06-01 - v2.0.0

* Initial release of the new Indexing Engine, powering the in-app Index Advisor for pganalyze
  - This replaces the old Index Advisor logic (considered v1 within the context of the engine), and represents a major change in how the query workload is assessed - v1 worked on a per-query basis, this new version works on a per-table basis and assesses all queries referencing that table
