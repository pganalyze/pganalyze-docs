...
const BlockingQueryGuidance: React.FunctionComponent<CheckGuidanceProps> = ({
  ...
  const showAutovacuum =
    !issueDetails || issueDetails["has_autovacuum_to_prevent_wraparound"];
  return (
    <div>
      <h4>Impact</h4>
      <p>
