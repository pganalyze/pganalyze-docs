...
* **`enableLogs` (Boolean)**<br/>Determines whether log collection is enabled (optional, defaults to false, works with Amazon RDS and [self-managed servers](https://github.com/pganalyze/collector#setting-up-log-pg_read_file-helper))
