...
To learn more about working with GraphQL in general, including using query
variables rather than the simple string interpolation used in our examples,
please consult [the official GraphQL documentation](https://graphql.org/graphql-js/graphql-clients/).
...
the pganalyze settings and statistics data. 2) Mutation endpoints, which are used
to change (mutate) the pganalyze settings.
