...
* For self-managed servers, you can either [add the pg_read_file helper](/docs/install/troubleshooting/pg_read_file helper) and then turn on the Log Insights flag on the server settings page, or run the collector separately
