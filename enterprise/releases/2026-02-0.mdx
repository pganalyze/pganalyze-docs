...
- This release changes some GraphQL API fields from a serialized JSON type that needs parsing, to instead be inlined in the GraphQL response. If you're currently using a private API accessing the following types, you might have to update your client: <!-- 5582 -->
