...
- **Important:** If you are currently running v2024.04.X or older, we highly recommend first upgrading to v2024.10.0 and staying there for 7 days
...
- Index Advisor
  ...
  - pg_plan: Support additional built-in functions <!-- 4533 -->
