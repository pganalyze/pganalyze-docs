...
* Support for Log Insights when monitoring self-managed servers using the collector within the pganalyze Enterprise Server container
  ...
  - If you are using the restricted monitoring user this requires [additional setup steps](https://github.com/pganalyze/collector#setting-up-log-pg_read_file-helper)
