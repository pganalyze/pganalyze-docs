...
## Sidekiq monitoring using Prometheus

The metrics HTTP endpoint `/metrics` is available for the Prometheus scraping. Currently, it provides Sidekiq metrics using [sidekiq-prometheus-exporter gem](https://github.com/Strech/sidekiq-prometheus-exporter).
