...
**Please note** that the slim container image does not contain a built-in pganalyze collector application. Therefore, you will need to have a [standalone pganalyze collector](https://pganalyze-we-pganalyze--tcuqan.herokuapp.com/docs/enterprise/setup/separate-collector-install) 
...
* A standalone Postgres database to store pganalyze statistics information
