...
Query Advisor checks are **enabled by default** for all databases in your pganalyze organization on Scale and Enterprise plans, but **alerts must be explicitly configured** to receive notifications about newly detected optimization opportunities for new customers.
