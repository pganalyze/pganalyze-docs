...
- **Wrong Index Due To ORDER BY**: Detects when PostgreSQL uses an index only for sorting while filtering large numbers of rows, suggesting better index usage patterns
