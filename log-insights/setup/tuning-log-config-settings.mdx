...
This will then give you the following log events: [W40: Checkpoint starting](/docs/log-insights/wal-checkpoints/W40), [W41: Checkpoint complete](/docs/log-insights/wal-checkpoints/W41) as well as others.
...
operations ([A65: Automatic vacuum of table completed](/docs/log-insights/maintenance/A65) and
[A66: Automatic analyze of table completed](/docs/log-insights/maintenance/A66)):
