...
<img alt="Add new syslog service integration in Aiven Console" src={imgAddSyslogIntegration} />

Once this is done, return to the service details page for your database, and
click Manage Integrations:

<img alt="Manage Integrations item in database details page" src={imgManageIntegrations} />

Scroll down to the bottom, find the Rsyslog tile, and click "Use Integration":

<img alt="Select the Rsyslog integration in the integration list" src={imgUseSyslogIntegration} />
...
<img alt="Select the Rsyslog integration" src={imgSyslogIntegrationActive} />
