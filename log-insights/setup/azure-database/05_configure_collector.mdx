...
If the VM has multiple Managed Identities assigned, specify the client ID of the specific Managed Identity created in Step 1 using `AZURE_CLIENT_ID` environment variable.
