...
* [Supabase](/docs/log-insights/setup/supabase/01_set_up_log_drain)
* [Neon](/docs/log-insights/setup/neon/01_set_up_opentelemetry_logs)
* [Self-Managed Server](/docs/log-insights/setup/self-managed/01_determine_log_location)
  ...
  - [Kubernetes with OpenTelemetry](/docs/log-insights/setup/opentelemetry)
