...
* Each role has one or more [permissions](/docs/accounts/permissions) that may be restricted to a database, server, or server group
...
* [SAML 2.0](/docs/accounts/sso) (Okta, Microsoft Entra ID & more)
