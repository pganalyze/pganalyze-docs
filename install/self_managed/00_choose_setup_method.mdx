 ...
 * **guided setup**: run a program included with the collector, which will prompt you for input and confirmation
...
also install [Automated EXPLAIN](https://pganalyze.com/postgres-explain) and
