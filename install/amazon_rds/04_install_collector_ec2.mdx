...
import PackageApt from "../_package_apt.mdx";
import PackageYum from "../_package_yum.mdx";
...
<p>
  <img src="/images-old/docs/rds_new_instance_role.png" width="694.4" />
</p>
...
<ul className="nav nav-tabs">
  <li className="nav-item">
    <a href="#yum" data-toggle="tab" className="nav-link active">
      YUM (RedHat/CentOS/Amazon Linux)
    </a>
  </li>
  <li className="nav-item">
    <a href="#apt" data-toggle="tab" className="nav-link">
      APT (Debian/Ubuntu)
    </a>
  </li>
</ul>
...
<div className="tab-content">
  <div className="tab-pane active" id="yum">
    <PackageYum />
  </div>
  <div className="tab-pane" id="apt">
    <PackageApt />
  </div>
</div>
