...
As an RDS superuser, connect to the database you will be monitoring and
run the following, replacing `mypassword` with one of your choosing:
...
<Link className="btn btn-success" to="03_install_collector">
  Proceed to Step 3: Install Collector
</Link>
