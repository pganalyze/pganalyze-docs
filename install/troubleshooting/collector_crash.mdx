...
Before increasing the memory limit of the collector, you may want to try enabling the collector's
<a href="/docs/install/troubleshooting/reset_stat_statements">automatic pg_stat_statements reset</a>
